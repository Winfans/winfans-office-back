...
@Entity
@Table(name = "jobgo_jg_db_enterprise_status", schema = "jobgo_jg_db", catalog = "")
public class JobgoJgDbEnterpriseStatus {
    ...
    public boolean equals(Object o) {
        ...
        JobgoJgDbEnterpriseStatus that = (JobgoJgDbEnterpriseStatus) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(entId, status, submitTime, passTime, logOutTime, lastFailTime);
    }
}
